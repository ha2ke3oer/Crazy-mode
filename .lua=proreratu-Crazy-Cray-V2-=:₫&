...
Achievements.Get({
    ...
    Desc = "Rooms & room",
    Reason = 'V2 fix lag',
    Image = "https://github.com/huyhoanphuc/roomsanddoors-20-20-20-20-20-20/blob/main/táº£i xuá»‘ng (6).jpeg?raw=true ",
})
...
function Aten()
    ...
    pcall(function()
        ...
        local entity = Creator.createEntity({
            ...
            CustomDialog = {"You died to Silentce"}, -- Custom death message (can be as long as you want)
        })
